...
public class Mylinklists {
    ...
    void push(int new_data) {
        /*
         * Cấp phát bộ nhớ cho node mới Truyền giá trị vào cho node mới
         */
        Node newNode = new Node(new_data);

        /*
         * Làm cho node tiếp theo của node mới trở thành node head (tức là làm cho con
         * trỏ next của node mới trỏ đến node head)
         */
        newNode.next = head;
